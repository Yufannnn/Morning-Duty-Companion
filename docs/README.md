...
### Step 1: Save Room List Data from the Tutor Resource Folder 🗂️
...
2. Open the most recent Room List file. 📑
   ...
   <p align="center">
     <img src="Room_Sheet.png" alt="Room List" width="500px">
   </p>

3. Navigate to the desired block's data by selecting the corresponding tab. 🔍

   <p align="center">
     <img src="Tab.png" alt="Tab Selection" width="500px">
   </p>

4. Navigate to the File menu and save the data as a CSV file. 💾

   <p align="center">
     <img src="Save.png" alt="Save Data" width="500px">
   </p>
...
5. To delete a record, click the remove button associated with the record. ❌
   ...
   <p align="center">
     <img src="Add.png" alt="Add a Boarder Record" width="500px">
   </p>
...
2. You can easily copy the generated message by clicking the "Copy to Clipboard" button. 📋
   ...
   <p align="center">
     <img src="Generate.png" alt="Generate Message" width="500px">
   </p>

3. The message text is editable, so feel free to make any necessary changes before copying and sending it to the BMs. ✏️
...
2. Further UI beautification to enhance the user experience. 🖌️
...
Enjoy using Morning Duty Companion to simplify your morning-duty management tasks! 😄
